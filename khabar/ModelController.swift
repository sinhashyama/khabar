...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    override init() {
        ...
        link = epaperLink().getEpaperLink(epaperName: userselect.getEpaper, stateName: userselect.getState, cityName: userselect.getCity)
        print("link : \(link)")
        self.initializeLinkArray()
    }
    ...
    func initializeLinkArray(){
        for i in 1...15 {
            let linkTemp = link.replacingOccurrences(of: "-number", with: String(i))
